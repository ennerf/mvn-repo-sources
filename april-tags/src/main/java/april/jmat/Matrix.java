...
public class Matrix
{
     ...
     **/
    public void writeMatlab(BufferedWriter outs, String matname) throws IOException
    {
        outs.write("rows_=[\n");
        for (int i = 0; i < m; i++)
            for (int j = 0; j < n; j++)
