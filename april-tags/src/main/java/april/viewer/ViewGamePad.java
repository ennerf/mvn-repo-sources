...
public class ViewGamePad implements ViewObject, LCMSubscriber
{
    ...
    void messageReceivedEx(String channel, LCMDataInputStream ins) throws IOException
    {
        ...
        //vis2 vb.addBack(new VisWindow(VisWindow.ALIGN.BOTTOM_RIGHT, 80, 80, new double[] { -1, -1 }, new double[] { 1, 1 }, new VzCircle(1, new VisDataFillStyle(Color.gray), new VisDataLineStyle(Color.darkGray, 2)), new VisChain(LinAlg.translate(turn, forward, 0), new VzCircle(0.1, new VisDataFillStyle(Color.white), new VisDataLineStyle(Color.black, 1)))));
        vb.swap();
    }
}
